...
CREATE OR REPLACE FUNCTION public.x64_decode(enc_str TEXT)
...
CREATE OR REPLACE FUNCTION public.x64_decode(enc_str BYTEA)
RETURNS SETOF TEXT AS $BODY$
BEGIN
...
CREATE OR REPLACE FUNCTION public.x64_encode(raw_str TEXT)
RETURNS SETOF TEXT AS $BODY$
BEGIN
